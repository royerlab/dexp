...
@click.option('--modes', '-m', type=str, default='max',
              ...
              show_default=True)
@click.option('--alphas', '-a', type=str, default='1.0',
              help='List of alpha values for each input image',
              show_default=True)
@click.option('--scales', '-s', type=str, default='1.0',
              ...
              show_default=True)
@click.option('--translations', '-t', type=str, default='0,0', help='List of translations ‘x0,y0|x1_y1|...’ for each input image, starting with the second one (first image is always at 0,0). If set to 0,0 no translation is performed for any image. ',
              show_default=True)
