...
@click.option('--crop', '-c', type=str, default=None,
              ...
              show_default=True)
@click.option('--resize', '-r', type=str, default=None,
              ...
              show_default=True)
@click.option('--resizeorder', '-ro', type=int, default=3,
              help='The order of the spline interpolation, default is 3. The order has to be in the range 0-5.',
              show_default=True)
@click.option('--resizemode', '-rm', type=str, default='constant',
...
@click.option('--overwrite', '-w', is_flag=True,
              help='Force overwrite of output images.',
              show_default=True)
@click.option('--workers', '-k', type=int, default=-1,
              help='Number of worker threads to spawn, set to -1 for maximum number of workers',
              show_default=True)  #
@click.option('--workersbackend', '-wkb', type=str, default=_default_workers_backend,
...
@click.option('--device', '-d', type=int, default=0,
              help='Sets the CUDA devices id, e.g. 0,1,2',
              show_default=True)  #
def overlay(input_path,
    ...
    crop_resize_pad_image_sequence(input_path=input_path,
