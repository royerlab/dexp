...
def nikon16x08na(dxy=0.406, dz=2, wvl=0.561, size = 31):
    zv = numpy.arange(-dz*(size//2), dz*(1+size//2), dz)

    # def gLXYZFocalScan(mp, dxy, xy_size, zv, normalize = True, pz = 0.0, wvl = 0.6, zd = None):
    return gLXYZFocalScan(m_params, dxy, size, zv, wvl=wvl)
