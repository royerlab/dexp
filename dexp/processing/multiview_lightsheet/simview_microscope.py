...
def simview_fuse_2I2D(backend: Backend,
    ...
    with timeit("SimView 2I2D fusion"):
        ...
        with timeit(f"Fuse illumination views C0L0 and C0L1..."):
            C0lx = fuse_illumination_views(backend, C0L0, C0L1, mode=fusion)
            del C0L0
            del C0L1
            gc.collect()
        ...
        with timeit(f"Fuse illumination views C1L0 and C1L1..."):
            C1Lx = fuse_illumination_views(backend, C1L0, C1L1, mode=fusion)
            del C1L0
            del C1L1
            gc.collect()
        ...
        with timeit(f"Fuse detection views C0lx and C1Lx..."):
            CxLx = fuse_detection_views(backend, C0lx, C1Lx, mode=fusion)
            del C0lx
            del C1Lx
            gc.collect()
