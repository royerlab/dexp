...
def simview_fuse(backend, length_xy=320):
    ...
    with gui_qt():
        ...
        viewer = Viewer()
        viewer.add_image(_c(C0L0), name='C0L0', contrast_limits=(0, 600))
        viewer.add_image(_c(C0L1), name='C0L1', contrast_limits=(0, 600))
        viewer.add_image(_c(C1L0), name='C1L0', contrast_limits=(0, 600))
        viewer.add_image(_c(C1L1), name='C1L1', contrast_limits=(0, 600))
