...
C0lx = ff.fuse_illumination_views(C0L0, C0L1, as_numpy=False)
C0L0 = ff._cn(C0L0)
C0L1 = ff._cn(C0L1)
...
print(f"fuse_lightsheets...")
C1lx = ff.fuse_illumination_views(C1L0, C1L1, as_numpy=False)
C1L0 = ff._cn(C1L0)
C1L1 = ff._cn(C1L1)
...
C0lx, C1lx, shifts = ff.register_views(C0lx, C1lx, as_numpy=False)
print(f"shifts = {shifts}")
print(f"fuse_cameras...")
CxLx = ff.fuse_detection_views(C0lx, C1lx, as_numpy=False)
stop = time.time()
