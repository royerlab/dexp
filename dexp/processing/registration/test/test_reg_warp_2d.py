...
from dexp.processing.registration.demo.demo_reg_warp_2d import _register_warp_2d
...
def register_warp_2d(backend, warp_grid_size=3, reg_grid_size=6):
    xp = backend.get_xp_module()
    sp = backend.get_sp_module()

    image, warped, unwarped, model = _register_warp_2d(backend, warp_grid_size=warp_grid_size, reg_grid_size=reg_grid_size, display=False)
