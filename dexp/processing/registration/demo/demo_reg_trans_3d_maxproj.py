...
def demo_register_translation_3d_maxproj_numpy():
    ...
    _register_translation_3d_maxproj(backend)
...
def _register_translation_3d_maxproj(backend, method=register_translation_2d_dexp, length_xy=256, display=True):
    ...
    with timeit("register_translation_maxproj_nd"):
        model = register_translation_maxproj_nd(backend, image1, image2, register_translation_2d=method)
        print(f"model: {model}")
